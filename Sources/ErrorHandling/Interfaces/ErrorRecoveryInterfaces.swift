...
/// recovery options.
public struct ErrorRecoveryOption: UmbraErrorsCore.RecoveryOption, Sendable, Equatable,
Identifiable {
...
extension ErrorRecoveryOption {
  ...
  public static var cancel: ErrorRecoveryOption {
    ErrorRecoveryOption(
      title: "Cancel",
  ...
  public static func tryAgain(handler: @escaping @Sendable () async -> Void)
  -> ErrorRecoveryOption {
    ErrorRecoveryOption(
      title: "Try Again",
