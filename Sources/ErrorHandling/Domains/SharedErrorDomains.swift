...
extension Interfaces.ErrorSource {
  ...
  public func toUmbraErrorsCoreType() -> UmbraErrorsCore.ErrorSource {
    return UmbraErrorsCore.ErrorSource(file: self.file, line: self.line, function: self.function)
  }
}
...
extension UmbraErrorsCore.ErrorSource {
  ...
  public func toInterfacesType() -> Interfaces.ErrorSource {
    return Interfaces.ErrorSource(file: self.file, line: self.line, function: self.function)
  }
}
...
public func convertToInterfacesSource(_ source: UmbraErrorsCore.ErrorSource?) -> Interfaces.ErrorSource? {
  guard let source = source else { return nil }
  return Interfaces.ErrorSource(from: source)
}

/// Convert Interfaces.ErrorSource to UmbraErrorsCore.ErrorSource safely
public func convertToUmbraErrorsCoreSource(_ source: Interfaces.ErrorSource?) -> UmbraErrorsCore.ErrorSource? {
  guard let source = source else { return nil }
