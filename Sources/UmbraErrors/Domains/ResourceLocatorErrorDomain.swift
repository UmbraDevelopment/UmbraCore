...
public enum ResourceLocatorError: Error, Equatable, Sendable {
    ...
    public func toUmbraError() -> UmbraError {
        switch self {
        case .invalidPath:
            return ResourceLocatorErrorDomain.makeInvalidPathError()
        case .resourceNotFound:
            return ResourceLocatorErrorDomain.makeResourceNotFoundError()
        case .accessDenied:
            return ResourceLocatorErrorDomain.makeAccessDeniedError()
        case .unsupportedScheme:
            return ResourceLocatorErrorDomain.makeUnsupportedSchemeError()
        case .generalError(let message):
            return ResourceLocatorErrorDomain.makeGeneralError(description: message)
        }
    }
}
