...
/// Protocol defining cryptographic operations in a Foundation-independent manner.
/// This protocol uses only primitive types and Foundation-independent custom types.
public protocol CryptoServiceProtocol: Sendable {
  ...
  ///   - nonce: Optional initialisation vector or nonce
