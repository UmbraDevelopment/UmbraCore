...
public protocol CryptoServiceTypeAdapterProtocol: Sendable {
  ...
  func encrypt(data: SecureBytes, key: SecureBytes) async -> Result<SecureBytes, SecurityProtocolError>
  
  /// Decrypt data using the specified key
  func decrypt(data: SecureBytes, key: SecureBytes) async -> Result<SecureBytes, SecurityProtocolError>
...
public struct CryptoServiceTypeAdapter<Adaptee: CryptoServiceTypeAdapterProtocol>: CryptoServiceProtocol {
  // MARK: - Properties
