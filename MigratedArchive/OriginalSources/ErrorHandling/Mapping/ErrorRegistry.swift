...
public final class ErrorRegistry {
  ...
  private func key(sourceType: (some Error).Type, targetType: (some Error).Type) -> String {
    "\(String(describing: sourceType))->\(String(describing: targetType))"
  }
