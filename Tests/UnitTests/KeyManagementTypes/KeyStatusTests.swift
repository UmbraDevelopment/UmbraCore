...
final class KeyStatusTests: XCTestCase {
  ...
  func testRawStatusConversion() {
    ...
    XCTAssertEqual(
      KeyManagementTypes.KeyStatus.pendingDeletion(date).toRawStatus(),
    ...
    XCTAssertEqual(
      KeyManagementTypes.KeyStatus.from(rawStatus: .pendingDeletion(date)),
      .pendingDeletion(date)
    )
    XCTAssertEqual(
  ...
  func testRawStatusEquality() {
    ...
    XCTAssertEqual(
      KeyManagementTypes.KeyStatus.RawStatus.active,
      KeyManagementTypes.KeyStatus.RawStatus.active
    )
    XCTAssertNotEqual(
      KeyManagementTypes.KeyStatus.RawStatus.active,
      KeyManagementTypes.KeyStatus.RawStatus.compromised
    )
