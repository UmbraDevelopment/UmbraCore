#!/usr/bin/env python3
"""
Security Types Migration Verifier

This script verifies the successful migration of the SecurityTypes module
to the Alpha Dot Five architecture by checking for required files and validating 
build configurations.

Usage:
    python security_types_migration_verifier.py
"""
...
OLD_MODULE_PATH = PROJECT_ROOT / "Sources/SecurityTypes"
NEW_MODULE_PATH = PROJECT_ROOT / "packages/UmbraCoreTypes/Sources/SecurityTypes"
...
REQUIRED_COMPONENTS = [
    ...
    "README.md",
    "Types/SecureBytes.swift",
    "Types/HashAlgorithm.swift",
    "Types/SecurityError.swift",
    "Types/SecurityError+Extended.swift",
    "Protocols/SecurityProvider.swift",
    "Protocols/SecureStorageProvider.swift",
]
...
def main() -> None:
    ...
    print(f"\n{Colours.BOLD}Security Types Migration Verifier{Colours.END}")
    print(f"Checking migration status for SecurityTypes module...\n")
    ...
    if all_passed:
        ...
        print("The SecurityTypes module has been successfully migrated to the Alpha Dot Five architecture.")
    ...
    print("   bazelisk build //packages/UmbraCoreTypes/Sources/SecurityTypes:SecurityTypes --verbose_failures")
    print("2. Update the remaining CoreDTOs references to use the migrated SecurityTypes")
