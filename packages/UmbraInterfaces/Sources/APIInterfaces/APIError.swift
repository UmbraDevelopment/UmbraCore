...
extension APIError {
    ...
    public func createContext(
        ...
        case .resourceNotFound(let message, let identifier):
        ...
        case .operationTimedOut(let message, let timeout):
        ...
        case .invalidState(let message, let stateDetails):
            description = "Invalid State"
            details = "\(message) (Details: \(stateDetails))"
            userReportable = true
            expected = false
            
        case .conflict(let message, let conflictDetails):
            description = "Conflict"
            details = "\(message) (Details: \(conflictDetails))"
            userReportable = true
            expected = true
            
        case .rateLimitExceeded(let message, let resetTime):
