...
/// This protocol is foundation-independent and provides a clean interface for network communication.
public protocol NetworkServiceProtocol: Sendable {
    ...
    func performRequestAndDecode<T: Decodable>(_ request: NetworkRequestProtocol, as type: T.Type) async throws -> T
...
public extension NetworkServiceProtocol {
    ...
    /// - Returns: A NetworkResponseDTO containing the result
    func get(_ urlString: String) async throws -> NetworkResponseDTO {
    ...
    /// - Returns: A NetworkResponseDTO containing the result
    func post(_ urlString: String, body: RequestBody) async throws -> NetworkResponseDTO {
