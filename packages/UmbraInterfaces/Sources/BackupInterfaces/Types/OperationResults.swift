 ...
 */
public struct AlphaDotFiveCopyResult: Sendable, Equatable {
 ...
 */
public struct AlphaDotFiveDeleteResult: Sendable, Equatable {
 ...
 */
public enum AlphaDotFiveExportFormat: String, Sendable, Equatable {
 ...
 */
public struct AlphaDotFiveExportResult: Sendable, Equatable {
    ...
    public let format: AlphaDotFiveExportFormat
    ...
    public init(
        snapshotID: String,
        destinationPath: URL,
        format: AlphaDotFiveExportFormat,
        completionTime: Date = Date(),
 ...
 */
public enum AlphaDotFiveImportFormat: String, Sendable, Equatable {
    /// Archive format (e.g., tar)
    case archive
 ...
 */
public struct AlphaDotFiveImportResult: Sendable, Equatable {
    ...
    public let format: AlphaDotFiveImportFormat
    ...
    public init(
        snapshotID: String,
        sourcePath: URL,
        format: AlphaDotFiveImportFormat,
        completionTime: Date = Date(),
 ...
 */
public struct AlphaDotFiveSnapshotComparisonResult: Sendable, Equatable {
