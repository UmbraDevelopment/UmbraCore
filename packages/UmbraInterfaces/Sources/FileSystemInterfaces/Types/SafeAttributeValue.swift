...
public enum SafeAttributeValue: Sendable, Equatable {
    ...
    public func asInt() -> Int? {
        ...
        case let .int64(value): return Int(exactly: value)
        case let .uint64(value): return Int(exactly: value)
        default: return nil
        }
    }
    ...
    public func asUInt() -> UInt? {
        ...
        case let .int64(value): return UInt(exactly: value)
        case let .uint64(value): return UInt(exactly: value)
        default: return nil
        }
    }
    ...
    public func asInt64() -> Int64? {
        switch self {
        case let .int(value): return Int64(value)
        case let .uint(value): return Int64(exactly: value)
        case let .int64(value): return value
        case let .uint64(value): return Int64(exactly: value)
        default: return nil
        }
    }
    ...
    public func asUInt64() -> UInt64? {
        ...
        case let .uint(value): return UInt64(value)
        case let .int64(value): return UInt64(exactly: value)
