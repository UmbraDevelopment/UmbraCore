...
public protocol FileMetadataOperationsProtocol: Actor, Sendable {
   ...
   */
  func setAttributes(_ attributes: [FileAttributeKey: Any], at path: String) async throws
   ...
   */
  func getExtendedAttributes(at path: String) async throws
   ...
   */
  func getExtendedAttribute(name: String, at path: String) async throws
    -> (Data, FileOperationResultDTO)
   ...
   */
  func getResourceValues(forKeys keys: Set<URLResourceKey>, at path: String) async throws
    -> ([URLResourceKey: Any], FileOperationResultDTO)
}
