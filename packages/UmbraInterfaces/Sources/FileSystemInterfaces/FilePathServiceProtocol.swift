...
public protocol FilePathServiceProtocol: Sendable {
     ...
     */
    func createPath(from path: String, isDirectory: Bool) -> SecurePath?
     ...
     */
    func joinPath(_ base: SecurePath, _ components: String...) -> SecurePath?
     ...
     */
    func exists(_ path: SecurePath) -> Bool
     ...
     */
    func isDirectory(_ path: SecurePath) -> Bool
     ...
     */
    func isFile(_ path: SecurePath) -> Bool
     ...
     */
    func parentDirectory(of path: SecurePath) -> SecurePath?
     ...
     */
    func lastComponent(of path: SecurePath) -> String
     ...
     */
    func fileExtension(of path: SecurePath) -> String?
     ...
     */
    func changingFileExtension(of path: SecurePath, to extension: String) -> SecurePath?
     ...
     */
    func temporaryDirectory() -> SecurePath
     ...
     */
    func uniqueTemporaryFile(extension: String?) -> SecurePath
     ...
     */
    func createSecurityBookmark(for path: SecurePath) -> SecurePath?
     ...
     */
    func resolveSecurityBookmark(_ path: SecurePath) -> SecurePath?
     ...
     */
    func startAccessingSecurityScopedResource(_ path: SecurePath) -> Bool
     ...
     */
    func stopAccessingSecurityScopedResource(_ path: SecurePath)
    ...
    /**
     ...
     - Returns: The current working directory path
     */
    func currentDirectory() -> SecurePath
     ...
     */
    func systemDirectory(_ directory: SystemDirectory) -> SecurePath
}
