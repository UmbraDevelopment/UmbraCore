...
public struct FileOperationResultDTO: Sendable, Equatable {
    ...
    public static func success(path: String, metadata: FileMetadataDTO? = nil) -> FileOperationResultDTO {
    ...
    public static func warning(path: String, warnings: [String], metadata: FileMetadataDTO? = nil) -> FileOperationResultDTO {
        return FileOperationResultDTO(
            status: .warning,
            path: path,
            metadata: metadata,
    ...
    public static func failure(path: String, context: [String: String]? = nil) -> FileOperationResultDTO {
        return FileOperationResultDTO(
            status: .failure,
            path: path,
            context: context
