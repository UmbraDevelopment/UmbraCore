...
public protocol DateTimeServiceProtocol: Sendable {
     ...
     */
    func timeIntervalBetween(from: DateTimeTypes.DateTimeDTO, to: DateTimeTypes.DateTimeDTO) async -> TimeIntervalDTO
     ...
     */
    func add(interval: TimeIntervalDTO, to date: DateTimeTypes.DateTimeDTO) async -> DateTimeTypes.DateTimeDTO
     ...
     */
    func subtract(interval: TimeIntervalDTO, from date: DateTimeTypes.DateTimeDTO) async -> DateTimeTypes.DateTimeDTO
     ...
     */
    func isBefore(_ date: DateTimeTypes.DateTimeDTO, _ otherDate: DateTimeTypes.DateTimeDTO) async -> Bool
     ...
     */
    func isAfter(_ date: DateTimeTypes.DateTimeDTO, _ otherDate: DateTimeTypes.DateTimeDTO) async -> Bool
