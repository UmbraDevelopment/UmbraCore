...
public protocol TaskSchedulingServiceProtocol: Sendable {
     ...
     */
    func scheduleTask(_ task: ScheduledTaskDTO, options: TaskSchedulingOptions) async throws -> ScheduledTaskDTO
...
public enum TaskSchedulingError: Error, Sendable, Equatable {
    ...
    public var localizedDescription: String {
        ...
        case .invalidTaskData(let details):
            return "Invalid task data: \(details)"
        case .executionFailed(let details):
            return "Task execution failed: \(details)"
        case .invalidTaskState(let details):
            return "Invalid task state: \(details)"
        case .schedulingDisabled(let details):
            return "Task scheduling has been disabled: \(details)"
        ...
        case .taskCancelled(let taskID):
            return "Task was cancelled: \(taskID)"
