...
public protocol SchedulingServiceProtocol: Sendable {
    ...
    func listSchedules(withFrequency frequency: ScheduleDTO.Frequency) async -> Result<[ScheduleDTO], UmbraErrors.ErrorDTO>
    ...
    func listTasks(withStatus status: ScheduledTaskDTO.TaskStatus) async -> Result<[ScheduledTaskDTO], UmbraErrors.ErrorDTO>
    ...
    func listTasks(forSchedule scheduleID: String) async -> Result<[ScheduledTaskDTO], UmbraErrors.ErrorDTO>
