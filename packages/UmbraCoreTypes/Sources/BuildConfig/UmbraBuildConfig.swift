...
///
/// These environments control logging verbosity, debug features, and performance
/// optimisations.
public enum UmbraEnvironment: String, Sendable {
  ...
  ///
  /// Returns `true` for `.debug` and `.development` environments.
  ...
  ///
  /// Returns `true` for `.debug`, `.development`, and `.alpha` environments.
  ...
  ///
  /// Returns `true` for `.alpha`, `.beta`, and `.production` environments.
  public var prioritisePerformance: Bool {
    switch self {
      case .debug, .development:
        false
      case .alpha, .beta, .production:
...
///
/// These strategies control which cryptographic and storage backends are used.
public enum BackendStrategy: String, Sendable {
  ...
  ///
  /// Returns `true` for `.appleCK` backend.
  ...
  ///
  /// Returns `true` for `.restic` and `.ringFFI` backends.
...
///
/// These classifications control how sensitive information is handled.
...
///
/// These constants control logging behaviour.
public enum LoggingConstants {
  /// Default maximum log entry size (in characters).
  public static let maxLogEntrySize=10000
  ...
  ///
  /// Returns `.redactInReleaseOnly` for `.debug` and `.development` environments,
  /// and `.alwaysRedact` otherwise.
...
///
/// These behaviours control how sensitive information is redacted.
...
///
/// This factory provides methods for creating configurations with custom
/// environments and backend strategies.
public enum BuildConfigFactory {
  ...
  public static func createDebugConfig(
    ...
    createConfig(environment: .debug, backendStrategy: backendStrategy)
  }
  ...
  public static func createDevelopmentConfig(
    ...
    createConfig(environment: .development, backendStrategy: backendStrategy)
  }
  ...
  public static func createAlphaConfig(
    ...
    createConfig(environment: .alpha, backendStrategy: backendStrategy)
  }
  ...
  public static func createBetaConfig(
    ...
    createConfig(environment: .beta, backendStrategy: backendStrategy)
  }
  ...
  public static func createProductionConfig(
    ...
    createConfig(environment: .production, backendStrategy: backendStrategy)
  }
  ...
  public static func createSandboxedConfig(
    ...
    createConfig(environment: environment, backendStrategy: .appleCK)
  }
  ...
  public static func createCrossPlatformConfig(
    ...
    createConfig(environment: environment, backendStrategy: .ringFFI)
  }
}
...
///
/// These methods provide information about the current build configuration.
public enum CompilerDirectives {
  ...
  ///
  /// - Parameters:
  ///   - strategy: The backend strategy to check
  ///   - block: The code to execute
...
///
/// These options control how sensitive information is handled in logs.
