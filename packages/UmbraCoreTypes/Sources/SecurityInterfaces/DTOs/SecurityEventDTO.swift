...
public struct SecurityEventDTO: Sendable, Equatable {
    ...
    ///   - containsSensitiveInformation: Flag indicating whether the event contains sensitive information
...
public struct SecurityEventFilterDTO: Sendable, Equatable {
    ...
    ///   - includeSensitiveInformation: Flag indicating whether to include events with sensitive information
