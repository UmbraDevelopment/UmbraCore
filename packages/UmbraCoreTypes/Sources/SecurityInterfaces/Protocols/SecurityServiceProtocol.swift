...
public protocol SecurityServiceProtocol: Sendable {
    ...
    /// - Throws: SecurityError if the operation fails
    func retrieveSecuredData(_ securedData: [UInt8], securityContext: SecurityContextDTO) async throws -> [UInt8]
    ...
    func verifyDataIntegrity(_ data: [UInt8], verification: [UInt8], context: SecurityContextDTO) async throws -> Bool
