...
@objc
public protocol XPCServiceProtocolDefinition {
...
public enum XPCServiceProtocolDefinitionFactory {
  ...
  public static func createDefaultImplementation() -> XPCServiceProtocolDefinition {
    XPCServiceProtocolDefinitionImpl.shared
  }
}

/// Default implementation of the XPC service protocol definition
public final class XPCServiceProtocolDefinitionImpl: NSObject, XPCServiceProtocolDefinition,
@unchecked Sendable {
  ...
  public func synchroniseKeys(_: NSData, withReply reply: @escaping (Error?) -> Void) {
    ...
    let error=NSError(
      ...
      code: 1001,
      userInfo: [NSLocalizedDescriptionKey: "Method deprecated, use ModernXPCService instead"]
    )
    reply(error)
  }
