...
public final class SecurityProviderAdapter {
    // Define the SecurityProviderProtocol locally since we can't import it due to circular dependencies
    ...
    public func encrypt(_ data: SecureBytes, key: SecureBytes) async -> Result<SecureBytes, SecurityErrorDTO> {
        do {
    ...
    public func decrypt(_ data: SecureBytes, key: SecureBytes) async -> Result<SecureBytes, SecurityErrorDTO> {
        do {
