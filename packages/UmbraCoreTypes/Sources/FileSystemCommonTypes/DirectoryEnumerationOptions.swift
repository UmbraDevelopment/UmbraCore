...
public struct DirectoryEnumerationOptions: OptionSet, Sendable {
    ...
    public static let none = DirectoryEnumerationOptions(rawValue: 0)
    ...
    public static func fromFoundationOptions(_ options: FileManager.DirectoryEnumerationOptions) -> DirectoryEnumerationOptions {
