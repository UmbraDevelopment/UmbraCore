...
public struct PrivacyMetadata: Sendable, Equatable, Hashable {
    ...
    internal var storage: [String: PrivacyMetadataValue]
    ...
    public var entriesArray: [(key: String, value: String, privacy: LogPrivacyLevel)] {
        return storage.map { (key, value) in
            return (key: key, value: value.valueString, privacy: value.privacy)
        }
    }
...
public struct LogIdentifier: Sendable, Equatable, Hashable, CustomStringConvertible {
    ...
    private static func formatHex(from bytes: ArraySlice<UInt8>) -> String {
        return bytes.map { byteToHexString($0) }.joined()
    }
...
public struct LogContext: Sendable, Equatable, Hashable {
    ...
    public let correlationId: LogIdentifier
...
@frozen public struct PrivacyString: Sendable, Hashable {
    ...
    public static func == (lhs: PrivacyString, rhs: PrivacyString) -> Bool {
        return lhs.rawValue == rhs.rawValue && lhs.privacyAnnotations == rhs.privacyAnnotations
    }
}
...
extension PrivacyString: ExpressibleByStringInterpolation {
    public struct StringInterpolation: StringInterpolationProtocol {
        ...
        internal var resultString = ""
        internal var annotations: [Range<String.Index>: LogPrivacyLevel] = [:]
        ...
        public mutating func appendInterpolation<T>(_ value: T, privacy: LogPrivacyLevel) {
        ...
        public mutating func appendInterpolation<T>(sensitive value: T) {
            appendInterpolation(value, privacy: .sensitive)
        }
        
        public mutating func appendInterpolation<T>(hash value: T) {
    ...
    public init(stringLiteral value: String) {
        self.rawValue = value
        self.privacyAnnotations = [:]
    }
    
    public init(stringInterpolation: StringInterpolation) {
        self.rawValue = stringInterpolation.resultString
        self.privacyAnnotations = stringInterpolation.annotations
    }
}
