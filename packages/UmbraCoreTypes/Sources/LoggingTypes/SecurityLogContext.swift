...
public struct SecurityLogContext: LogContextDTO, Sendable, Equatable {
    ...
    public init(
        ...
        // Add operation and component as public metadata
    ...
    public func withResult(success: Bool) -> SecurityLogContext {
        let updatedMetadata = self.metadata.withPublic(key: "result", value: success ? "success" : "failure")
