...
public struct LogMetadataDTO: Sendable, Hashable, Equatable {
  ...
  public func toPrivacyMetadataValue() -> PrivacyMetadataValue {
    PrivacyMetadataValue(value: value, privacy: privacy)
  }
}
...
public struct CryptoLogContext: LogContextDTO {
  ...
  public func toPrivacyMetadata() -> PrivacyMetadata {
    ...
    if let algorithm, !additionalContext.contains(key: "algorithm") {
...
public struct LoggableError: LoggableErrorProtocol, Sendable, Equatable {
  ...
  public func toPrivacyMetadata() -> PrivacyMetadata {
    ...
    metadata["errorType"]=PrivacyMetadataValue(value: String(describing: type(of: error)),
                                               privacy: .public)
    metadata["localizedDescription"]=PrivacyMetadataValue(value: error.localizedDescription,
                                                          privacy: .private)
...
public struct FileSystemLogContext: LogContextDTO {
  ...
  public func toPrivacyMetadata() -> PrivacyMetadata {
    ...
    if let path, !additionalContext.contains(key: "path") {
