...
public struct UmbraLogDestinationConfigDTO: Sendable, Equatable {
  ...
  public static func custom(
    ...
    UmbraLogDestinationConfigDTO(parameters: parameters)
  }
}
...
extension UmbraLogDestinationConfigDTO: Codable {
  ...
  public init(from decoder: Decoder) throws {
    ...
    retentionPolicy=try container.decodeIfPresent(
      UmbraLogRetentionPolicyDTO.self,
      forKey: .retentionPolicy
    )
    filterRules=try container.decode([UmbraLogFilterRuleDTO].self, forKey: .filterRules)
    redactionRules=try container.decodeIfPresent(
      [UmbraLogRedactionRuleDTO].self,
      forKey: .redactionRules
    )
  }
