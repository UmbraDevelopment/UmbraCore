...
public class CreateBackupCommand: BasePersistenceCommand, PersistenceCommand {
     ...
     */
    public func execute(context: PersistenceContextDTO) async throws -> BackupResultDTO {
        ...
        do {
            ...
            if backupResult.success {
                var successMetadata: [(key: String, value: (value: String, privacyLevel: PrivacyLevel))] = [
                    ...
                    ("executionTime", (value: String(format: "%.3f", backupResult.executionTime), privacyLevel: .public))
                ]
