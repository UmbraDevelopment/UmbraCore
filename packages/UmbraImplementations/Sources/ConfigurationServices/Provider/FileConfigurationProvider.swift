...
public class FileConfigurationProvider: ConfigurationProviderProtocol {
  ...
  public func loadConfiguration(
    ...
    do {
      ...
      throw ConfigurationError
        .loadFailed("Failed to load configuration: \(error.localizedDescription)")
    }
  }
  ...
  public func saveConfiguration(
    ...
    guard destination.sourceType == .file else {
      throw ConfigurationError
        .sourceNotFound("Destination is not a file: \(destination.sourceType.rawValue)")
    }
    ...
    if !fileManager.fileExists(atPath: directoryURL.path) {
      do {
        ...
        throw ConfigurationError
          .saveFailed("Failed to create directory: \(error.localizedDescription)")
      }
    }
    ...
    do {
      ...
      throw ConfigurationError
        .saveFailed("Failed to save configuration: \(error.localizedDescription)")
    }
  }
  ...
  public func exportConfiguration(
    ...
    try generateData(from: configuration, format: format)
  }
  ...
  public func importConfiguration(
    ...
    try parseData(data, format: format)
  }
    ...
    switch format {
      case .json:
        do {
          ...
          throw ConfigurationError
            .parseFailed("Failed to parse JSON: \(error.localizedDescription)")
        }
    ...
    switch format {
      case .json:
        do {
          ...
          throw ConfigurationError
            .invalidFormat("Failed to encode to JSON: \(error.localizedDescription)")
        }
  ...
  private func validateType(
    _ value: ConfigValueDTO,
    against type: ConfigSchemaDTO.PropertyType
  ) -> Bool {
    switch (value, type) {
