...
public class ValidateConfigurationCommand: BaseConfigCommand, ConfigCommand {
   ...
   */
  public func execute(context _: LogContextDTO) async throws -> ConfigValidationResultDTO {
    ...
    do {
      ...
      let validationResult: ConfigValidationResultDTO=if let schema {
        ...
        ConfigValidationResultDTO.valid()
      }
   ...
   */
  private func performBasicValidation(context _: LogContextDTO) -> ConfigValidationResultDTO {
