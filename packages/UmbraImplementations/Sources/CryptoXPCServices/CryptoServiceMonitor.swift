...
public actor CryptoServiceMonitor: CryptoServiceMonitorProtocol {
    ...
    public init(logger: LoggingProtocol) {
        self.logger = logger
        self.cryptoLogger = CryptoMonitorLogger(logger: logger)
        self.eventStream = CryptoEventStream()
    }
 ...
 */
fileprivate final class CryptoEventStream: @unchecked Sendable {
 ...
 */
fileprivate struct CryptoMonitorLogger {
    private let logger: LoggingProtocol
