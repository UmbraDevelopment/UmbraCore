...
public final class SecureKeychainServiceDecorator: KeychainServiceProtocol {
    ...
    public func storePassword(
        ...
        await logger.debug("Successfully stored password in keychain with enhanced security", context: successContext)
    }
    ...
    public func updatePassword(
        ...
        // Delegate to the wrapped service
        try await wrappedService.updatePassword(newPassword, for: account, keychainOptions: keychainOptions)
        ...
        await logger.debug("Successfully updated password in keychain with enhanced security", context: successContext)
    }
    ...
    public func retrievePassword(
        ...
        // Delegate to the wrapped service
        let password = try await wrappedService.retrievePassword(for: account, keychainOptions: keychainOptions)
        ...
        await logger.debug("Successfully retrieved password from keychain with enhanced security", context: successContext)
    ...
    public func passwordExists(
        ...
        // Delegate to the wrapped service
        let exists = try await wrappedService.passwordExists(for: account, keychainOptions: keychainOptions)
    ...
    public func deletePassword(
        ...
        await logger.debug("Successfully deleted password from keychain with enhanced security", context: successContext)
    }
    ...
    public func storeData(
        ...
        await logger.debug("Successfully stored data in keychain with enhanced security", context: successContext)
    }
    ...
    public func retrieveData(
        ...
        let metadataWithSize = successContext.metadata.withPublic(key: "dataSize", value: String(data.count))
        let finalContext = successContext.withUpdatedMetadata(metadataWithSize)
        await logger.debug("Successfully retrieved data from keychain with enhanced security", context: finalContext)
    ...
    public func deleteData(
        ...
        await logger.debug("Successfully deleted data from keychain with enhanced security", context: successContext)
    }
}
