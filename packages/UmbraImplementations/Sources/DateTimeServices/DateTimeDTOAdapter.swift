...
public final class DateTimeDTOAdapter: DateTimeDTOProtocol {
  ...
  public func now(in timeZoneOffset: CoreDTOs.DateTimeDTO.TimeZoneOffset?=nil) -> CoreDTOs
  .DateTimeDTO {
    ...
    if let offsetToUse=timeZoneOffset {
      ...
      return CoreDTOs.DateTimeDTO(
        timestamp: timestamp,
        timeZoneOffset: CoreDTOs.DateTimeDTO.TimeZoneOffset.utc
      )
    }
  }
  ...
  public func difference(
    between date1: CoreDTOs.DateTimeDTO,
    and date2: CoreDTOs.DateTimeDTO
  ) -> Double {
