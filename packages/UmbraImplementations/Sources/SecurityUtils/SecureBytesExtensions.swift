...
public extension SecureBytes {
     ...
     */
    static func from(string: String, using encoding: String.Encoding = .utf8) -> SecureBytes? {
...
public extension Data {
     ...
     */
    func toSecureBytes() -> SecureBytes {
        return SecureBytes(bytes: [UInt8](self))
    }
}
