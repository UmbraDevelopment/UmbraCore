...
public enum XPCServices {
    ...
    public static func createService(
        ...
        return XPCServiceActor(serviceName: serviceName, logger: logger)
    }
    ...
    public static func createMockService(
        ...
        return MockXPCServiceActor(logger: logger)
    }
}
...
actor MockXPCServiceActor: XPCServiceProtocol {
    ...
    public func sendMessage<T: Sendable, R: Sendable>(
        ...
        throw XPCServiceError.endpointNotFound("No mock response configured for endpoint: \(endpointName)")
    }
     ...
     */
    public func configureMockResponse<R: Sendable>(
        _ response: R,
        for endpoint: XPCEndpointIdentifier
    ) async {
