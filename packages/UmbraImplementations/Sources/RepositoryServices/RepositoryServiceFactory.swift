...
public enum RepositoryServiceFactory {
    ...
    ///
    /// - Parameter logger: Optional logger to use for the service. If not provided, a default logger will be created.
    ...
    public static func createSharedInstance(logger: LoggingProtocol? = nil) -> RepositoryServiceProtocol {
