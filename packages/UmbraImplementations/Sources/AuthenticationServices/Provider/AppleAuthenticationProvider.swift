...
public class AppleAuthenticationProvider: AuthenticationProviderProtocol {
    ...
    switch credentials.methodType {
      ...
      case .biometric:
          ...
          throw AuthenticationError
            .biometricUnavailable("Biometric authentication not available on this platform")
        #endif
  ...
  private func evaluateBiometricPolicy(
    ...
    context _: LogContextDTO
      ...
      var error: NSError?
      let canEvaluate=authContext.canEvaluatePolicy(
      ...
      do {
        ...
        switch laError.code {
          ...
          case .biometryLockout:
            throw AuthenticationError
              .biometricFailed(
                "Biometric authentication locked out due to too many failed attempts"
              )
          default:
            throw AuthenticationError
              .biometricFailed("Biometric authentication failed: \(laError.localizedDescription)")
        }
      }
    #else
