...
public class RingAuthenticationProvider: AuthenticationProviderProtocol {
    ...
    public init(
        ...
        self.argon2Parameters = parameters
    }
    ...
    public func hashPassword(
        ...
        // Format the output as: $argon2id$v=19$m=<memory>$t=<iterations>$p=<parallelism>$<salt_base64>$<hash_base64>
    ...
    public func verifyPassword(
        ...
        guard let memoryCost = UInt32(memoryCostString),
