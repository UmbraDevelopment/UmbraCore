...
public enum LoggerFactory {
    ...
    public static func createCoreLogger(source: String) -> DomainLogger {
        ...
        return createDomainLoggerInternal(domainName: "CoreFramework", metadata: metadata, source: source)
    }
    ...
    public static func createCryptoLogger(source: String) -> DomainLogger {
        ...
        return createDomainLoggerInternal(domainName: "CryptoOperations", metadata: metadata, source: source)
    }
    ...
    public static func createSecurityLogger(source: String) -> DomainLogger {
        ...
        return createDomainLoggerInternal(domainName: "SecurityOperations", metadata: metadata, source: source)
    }
    ...
    public static func createKeyManagementLogger(source: String) -> DomainLogger {
        ...
        return createDomainLoggerInternal(domainName: "KeyManagement", metadata: metadata, source: source)
    }
    ...
    static func createDomainLoggerInternal(domainName: String, metadata: LogMetadataDTOCollection, source: String) -> DomainLogger {
...
public final class DefaultLoggingService: LoggingServiceProtocol {
    ...
    private func logWithLevel(_ level: UmbraLogLevel, message: String, metadata: LogMetadata?, source: String?) async {
...
public actor BasicLoggingProtocol: LoggingProtocol {
    ...
    public func log(_ level: LogLevel, _ message: String, context: LogContextDTO) async {
        ...
        for entry in context.metadata.entries {
            combinedMetadata = combinedMetadata.with(key: entry.key, value: entry.value, privacyLevel: entry.privacyLevel)
        }
        ...
        switch level {
        case .trace:
            umbraLevel = .debug // Map trace to debug as we don't have a direct mapping
        case .debug:
            umbraLevel = .debug
        case .info:
            umbraLevel = .info
