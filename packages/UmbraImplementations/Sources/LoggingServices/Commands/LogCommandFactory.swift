...
public class LogCommandFactory {
   ...
   */
  private func providerFor(
    destinationType: LoggingInterfaces
      .LogDestinationType
  ) -> LoggingProviderProtocol? {
    providers[destinationType]
  }
   ...
   */
  private func getDestination(id _: String) -> LoggingInterfaces.LogDestinationDTO? {
