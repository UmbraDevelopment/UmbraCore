...
public actor DefaultCryptoServiceImpl: CryptoServiceProtocol {
  ...
  public func encrypt(
    ...
    let actualOptions = options ?? self.factoryOptions.toCryptoServiceOptions()
  ...
  public func generateHash(
    ...
    case .sha256:
      ...
      hashData = await generateRandomBytes(count: 32)
    case .sha512:
      // Generate a mock SHA-512 hash (64 bytes)
      hashData = await generateRandomBytes(count: 64)
    }
