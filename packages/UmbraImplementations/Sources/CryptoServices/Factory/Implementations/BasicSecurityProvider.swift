...
public class BasicSecurityProvider: SecurityProviderProtocol {
  ...
  public func performOperation(
    ...
    switch operation {
      ...
      case .hashing:
        ...
        var hash: [UInt8]=switch algorithm {
          case .sha256:
            Array(repeating: 1, count: 32) // Mock SHA-256 hash (32 bytes)
          case .sha512:
            Array(repeating: 2, count: 64) // Mock SHA-512 hash (64 bytes)
        }
  ...
  public func generateKey(
    options _: SecurityProviderOptions
