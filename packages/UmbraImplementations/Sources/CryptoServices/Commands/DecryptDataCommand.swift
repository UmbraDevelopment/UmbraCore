...
public class DecryptDataCommand: BaseCryptoCommand, CryptoCommand {
    ...
    public func execute(
        ...
        case .success(let encryptedDataBytes):
            ...
            // [IV (16 bytes)][Encrypted Data (at least 1 byte)][Key ID Length (1 byte)][Key ID (at least 1 byte)]
            ...
            case .success(let keyData):
                do {
                    ...
                    case .chacha20Poly1305:
                        ...
                        decryptedData = try chacha20Poly1305Decrypt(data: encryptedContent, key: keyData, iv: iv)
                    }
    ...
    /**
     ...
     - Throws: Error if decryption fails
     */
    private func chacha20Poly1305Decrypt(data: [UInt8], key: [UInt8], iv: [UInt8]) throws -> [UInt8] {
