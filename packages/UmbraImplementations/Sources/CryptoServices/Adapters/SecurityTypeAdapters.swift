 ...
 */
public struct EncryptionOptionsAdapter {
    /**
     ...
     */
    public static func convert(_ options: SecurityCoreInterfaces.EncryptionOptions?) -> EncryptionOptions? {
    ...
    /**
     ...
     - Returns: The converted options or nil if input was nil
     */
    public static func convertToInterface(_ options: EncryptionOptions?) -> SecurityCoreInterfaces.EncryptionOptions? {
        guard let options = options else { return nil }
    ...
    private static func convert(_ algorithm: SecurityCoreInterfaces.EncryptionAlgorithm) -> EncryptionAlgorithm {
        switch algorithm {
        case .aes:
            return .aes
        case .chacha20:
    ...
    private static func convertToInterface(_ algorithm: EncryptionAlgorithm) -> SecurityCoreInterfaces.EncryptionAlgorithm {
        switch algorithm {
        case .aes:
            return .aes
        case .chacha20:
    ...
    private static func convertToInterface(_ mode: EncryptionMode) -> SecurityCoreInterfaces.EncryptionMode {
        switch mode {
        case .cbc:
            return .cbc
        case .gcm:
    ...
    private static func convert(_ padding: SecurityCoreInterfaces.EncryptionPadding) -> EncryptionPadding {
        switch padding {
        case .none:
            return .none
        case .pkcs7:
    ...
    private static func convertToInterface(_ padding: EncryptionPadding) -> SecurityCoreInterfaces.EncryptionPadding {
        switch padding {
        case .none:
            return .none
        case .pkcs7:
 ...
 */
public struct DecryptionOptionsAdapter {
    /**
     ...
     - Returns: The converted options or nil if input was nil
     */
    public static func convert(_ options: SecurityCoreInterfaces.DecryptionOptions?) -> DecryptionOptions? {
        guard let options = options else { return nil }
    ...
    /**
     ...
     - Returns: The converted options or nil if input was nil
     */
    public static func convertToInterface(_ options: DecryptionOptions?) -> SecurityCoreInterfaces.DecryptionOptions? {
        guard let options = options else { return nil }
 ...
 */
public struct HashingOptionsAdapter {
    /**
    ...
    /**
     ...
     - Returns: The converted options or nil if input was nil
     */
    public static func convertToInterface(_ options: HashingOptions?) -> SecurityCoreInterfaces.HashingOptions? {
        guard let options = options else { return nil }
    ...
    // Helper methods for algorithm conversion
    private static func convert(_ algorithm: SecurityCoreInterfaces.HashingAlgorithm) -> HashingAlgorithm {
        switch algorithm {
        case .sha256:
            return .sha256
        case .sha512:
    ...
    private static func convertToInterface(_ algorithm: HashingAlgorithm) -> SecurityCoreInterfaces.HashingAlgorithm {
        switch algorithm {
        case .sha256:
            return .sha256
        case .sha512:
 ...
 */
public struct KeyGenerationOptionsAdapter {
    /**
     ...
     - Returns: The converted options or nil if input was nil
     */
    public static func convert(_ options: SecurityCoreInterfaces.KeyGenerationOptions?) -> KeyGenerationOptions? {
        guard let options = options else { return nil }
    ...
    /**
     ...
     - Returns: The converted options or nil if input was nil
     */
    public static func convertToInterface(_ options: KeyGenerationOptions?) -> SecurityCoreInterfaces.KeyGenerationOptions? {
        guard let options = options else { return nil }
