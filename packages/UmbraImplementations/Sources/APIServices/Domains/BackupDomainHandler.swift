...
public struct BackupDomainHandler: DomainHandler {
     ...
     */
    private func executeBackupOperation<T: APIOperation>(_ operation: T) async throws -> Any {
        switch operation {
    ...
    /**
     ...
     - Throws: APIError if the operation fails
     */
    private func handleListSnapshots(_ operation: ListSnapshotsOperation) async throws -> [SnapshotInfo] {
    ...
    /**
     ...
     - Throws: APIError if the operation fails
     */
    private func handleGetSnapshot(_ operation: GetSnapshotOperation) async throws -> SnapshotDetails {
        // Create privacy-aware logging metadata
    ...
    /**
     ...
     - Throws: APIError if the operation fails
     */
    private func handleCreateSnapshot(_ operation: CreateSnapshotOperation) async throws -> SnapshotInfo {
        // Create privacy-aware logging metadata
        var metadata = PrivacyMetadata([
    ...
    /**
     ...
     - Throws: APIError if the operation fails
     */
    private func handleUpdateSnapshot(_ operation: UpdateSnapshotOperation) async throws -> SnapshotInfo {
        // Create privacy-aware logging metadata
        var metadata = PrivacyMetadata([
    ...
    /**
     ...
     - Throws: APIError if the operation fails
     */
    private func handleDeleteSnapshot(_ operation: DeleteSnapshotOperation) async throws -> Void {
        // Create privacy-aware logging metadata
        let metadata = PrivacyMetadata([
    ...
    /**
     ...
     - Throws: APIError if the operation fails
     */
    private func handleRestoreSnapshot(_ operation: RestoreSnapshotOperation) async throws -> RestoreResult {
        // Create privacy-aware logging metadata
        var metadata = PrivacyMetadata([
    ...
    /**
     ...
     - Throws: APIError if the operation fails
     */
    private func handleForgetSnapshot(_ operation: ForgetSnapshotOperation) async throws -> Void {
        // Create privacy-aware logging metadata
        let metadata = PrivacyMetadata([
