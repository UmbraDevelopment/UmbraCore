...
public enum LoggingServices {
    ...
    public static func createDomainLogger(domain: String, category: String) -> LoggingProtocol {
        return createLogger(domain: domain, category: category)
    }
    ...
    public static func DomainLogger(domain: String, category: String) -> LoggingProtocol {
        return createDomainLogger(domain: domain, category: category)
    }
}
 ...
 */
fileprivate enum LoggerFactory {
    /**
    ...
    static func createLogger(
        ...
        return ConsoleLogger(subsystem: subsystem, category: category)
    }
}
 ...
 */
fileprivate class ConsoleLogger: LoggingProtocol {
...
private class OSLogWrapper: LoggingProtocol {
    ...
    public func warn(_ message: String, metadata: PrivacyMetadata?, source: String) async {
    ...
    public func warn(_ message: String, context: LogContextDTO) async {
        print("[\(subsystem):\(category)] WARN: \(message)")
    }
...
private class BasicLogger: LoggingProtocol {
    ...
    public func debug(_ message: String, context: LogContext?) async {
        print("[\(domain):\(category)] DEBUG: \(message)")
    }
    
    public func info(_ message: String, context: LogContext?) async {
        print("[\(domain):\(category)] INFO: \(message)")
    }
    
    public func warning(_ message: String, context: LogContext?) async {
        print("[\(domain):\(category)] WARNING: \(message)")
    }
    
    public func error(_ message: String, context: LogContext?, error: Error?) async {
    ...
    public func critical(_ message: String, context: LogContext?, error: Error?) async {
