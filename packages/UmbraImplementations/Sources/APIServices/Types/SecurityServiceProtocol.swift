...
public protocol SecurityProviderProtocol {
     ...
     */
    func encryptData(_ data: Data, with key: SendableCryptoMaterial, using algorithm: EncryptionAlgorithm) async throws -> Data
     ...
     */
    func decryptData(_ data: Data, with key: SendableCryptoMaterial, using algorithm: EncryptionAlgorithm) async throws -> Data
