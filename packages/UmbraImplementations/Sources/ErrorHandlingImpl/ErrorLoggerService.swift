...
public actor ErrorLoggerService: ErrorLoggingProtocol {
    ...
    public func logError<E: Error>(
        ...
        metadata["errorType"] = .string(String(describing: type(of: error)))
        metadata["errorMessage"] = .string(error.localizedDescription)
        
        // Add domain information if available
        if let domainError = error as? any ErrorDomainProtocol {
            metadata["errorDomain"] = .string(String(describing: type(of: domainError).domain))
            metadata["errorCode"] = .string("\(domainError.code)")
        }
    ...
    /**
     ...
     - Parameters:
        ...
        - context: Optional contextual information about the error
     */
    public func debug<E: Error>(_ error: E, context: ErrorContext?) async {
    ...
    /**
     ...
     - Parameters:
        ...
        - context: Optional contextual information about the error
     */
    public func info<E: Error>(_ error: E, context: ErrorContext?) async {
    ...
    /**
     ...
     - Parameters:
        ...
        - context: Optional contextual information about the error
     */
    public func warning<E: Error>(_ error: E, context: ErrorContext?) async {
    ...
    /**
     ...
     - Parameters:
        ...
        - context: Optional contextual information about the error
     */
    public func error<E: Error>(_ error: E, context: ErrorContext?) async {
