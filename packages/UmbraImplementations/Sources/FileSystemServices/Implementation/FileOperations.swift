...
extension FileSystemServiceImpl {
    ...
    public func readFile(at path: FilePath) async throws -> [UInt8] {
        ...
        do {
            ...
            await logger.error("Failed to read file at \(path.path): \(error.localizedDescription)", metadata: nil)
    ...
    public func readTextFile(
        ...
        do {
            ...
            await logger.error("Failed to read text file at \(path.path): \(error.localizedDescription)", metadata: nil)
            throw FileSystemInterfaces.FileSystemError.readError(
                path: path.path,
                reason: error.localizedDescription
            )
    ...
    public func writeFile(
        ...
        if createDirectories {
            ...
            do {
                ...
                await logger.error("Failed to create parent directories for \(path.path): \(error.localizedDescription)", metadata: nil)
        ...
        do {
            ...
            await logger.error("Failed to write file at \(path.path): \(error.localizedDescription)", metadata: nil)
            throw FileSystemInterfaces.FileSystemError.writeError(
                path: path.path,
                reason: error.localizedDescription
            )
    ...
    public func appendData(
        ...
        do {
            ...
            await logger.error("Failed to append data to \(path.path): \(error.localizedDescription)", metadata: nil)
            throw FileSystemInterfaces.FileSystemError.writeError(
                path: path.path,
    ...
    public func removeFile(at path: FilePath) async throws {
        ...
        do {
            ...
            await logger.error("Failed to remove file at \(path.path): \(error.localizedDescription)", metadata: nil)
            throw FileSystemInterfaces.FileSystemError.writeError(
                path: path.path,
                reason: error.localizedDescription
            )
    ...
    public func copyFile(
        ...
        do {
            ...
            await logger.info("Copied file from \(sourcePath.path) to \(destinationPath.path)", metadata: nil)
        } catch {
    ...
    public func moveFile(
        ...
        do {
            ...
            await logger.info("Moved file from \(sourcePath.path) to \(destinationPath.path)", metadata: nil)
        } catch {
