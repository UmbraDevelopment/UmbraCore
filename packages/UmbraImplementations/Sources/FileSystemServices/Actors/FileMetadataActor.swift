...
public actor FileMetadataActor: FileMetadataProtocol {
    ...
    do {
      ...
      let successContext=context
        ...
        .withUpdatedMetadata(context.metadata.withPublic(
          key: "attributeCount",
          value: String(fileAttributes.count)
        ))
      ...
      await logger.error(
        "Failed to get file attributes: \(error.localizedDescription)",
        context: context
      )
      throw error
    } catch {
      ...
      await logger.error(
        "Failed to get file attributes: \(wrappedError.localizedDescription)",
        context: context
      )
      throw wrappedError
    }
  ...
  public func setAttributes(_ attributes: FileAttributes, at path: FilePathDTO) async throws {
    ...
    do {
      ...
      // Re-throw already wrapped errors
      await logger.error(
        "Failed to set file attributes: \(error.localizedDescription)",
      ...
      await logger.error(
        "Failed to set file attributes: \(wrappedError.localizedDescription)",
        context: enhancedContext
      )
      throw wrappedError
    }
  ...
  public func getFileSize(at path: FilePathDTO) async throws -> UInt64 {
    ...
    do {
      ...
      await logger.error(
        "Failed to get file size: \(wrappedError.localizedDescription)",
        context: context
      )
      throw wrappedError
    }
  ...
  public func getCreationDate(at path: FilePathDTO) async throws -> Date {
    ...
    do {
      ...
      let successContext=context
        ...
        .withUpdatedMetadata(context.metadata.withPublic(
          key: "creationDate",
          value: String(describing: creationDate)
        ))
      ...
      // Re-throw already wrapped errors
      await logger.error(
        "Failed to get file creation date: \(error.localizedDescription)",
        context: context
      )
      throw error
    } catch {
      ...
      await logger.error(
        "Failed to get file creation date: \(wrappedError.localizedDescription)",
        context: context
      )
      throw wrappedError
    }
    ...
    do {
      ...
      let successContext=context
        ...
        .withUpdatedMetadata(context.metadata.withPublic(
          ...
          value: String(describing: modificationDate)
        ))
      ...
      // Re-throw already wrapped errors
      await logger.error(
        "Failed to get file modification date: \(error.localizedDescription)",
        context: context
      )
      throw error
    } catch {
      ...
      await logger.error(
        "Failed to get file modification date: \(wrappedError.localizedDescription)",
        context: context
      )
      throw wrappedError
    }
  ...
  public func getExtendedAttribute(
    ...
    fromItemAtPath path: FilePathDTO
  ) async throws -> Data {
    let context=FileSystemLogContext(
    ...
    do {
      ...
      do {
        ...
        let attributeData=try FileManager.default.extendedAttribute(
          forName: name,
        ...
        let successContext=enhancedContext
          ...
          .withUpdatedMetadata(enhancedContext.metadata.withPublic(
            key: "dataSize",
            value: String(attributeData.count)
          ))
      ...
      await logger.error(
        "Failed to get extended attribute: \(wrappedError.localizedDescription)",
        context: enhancedContext
      )
      throw wrappedError
    }
  ...
  public func setExtendedAttribute(
    ...
    do {
      ...
      await logger.error(
        "Failed to set extended attribute: \(wrappedError.localizedDescription)",
        context: enhancedContext
      )
      throw wrappedError
    }
    ...
    do {
      ...
      do {
        ...
        let successContext=context
          ...
          .withUpdatedMetadata(context.metadata.withPublic(
            key: "attributeCount",
            value: String(attributeNames.count)
          ))
      ...
      await logger.error(
        "Failed to list extended attributes: \(wrappedError.localizedDescription)",
        context: context
      )
      throw wrappedError
    }
  ...
  public func removeExtendedAttribute(
    ...
    do {
      ...
      await logger.error(
        "Failed to remove extended attribute: \(wrappedError.localizedDescription)",
        context: enhancedContext
      )
      throw wrappedError
    }
