...
public actor SecureFileOperationsActor: SecureFileOperationsProtocol {
  ...
  public func createSecureTemporaryFile(
    ...
    do {
      ...
      await logger.error(
        "Failed to create secure temporary file: \(wrappedError.localizedDescription)",
        context: context
      )
      throw wrappedError
    }
  ...
  public func createSecureTemporaryDirectory(
    ...
    do {
      ...
      await logger.error(
        "Failed to create secure temporary directory: \(wrappedError.localizedDescription)",
        context: context
      )
      throw wrappedError
    }
  ...
  public func secureWriteFile(
    ...
    do {
      ...
      // Re-throw already wrapped errors
      await logger.error(
        "Failed to securely write file: \(error.localizedDescription)",
        context: context
      )
      throw error
    } catch {
      ...
      await logger.error(
        "Failed to securely write file: \(wrappedError.localizedDescription)",
        context: context
      )
      throw wrappedError
    }
  ...
  public func secureReadFile(
    at path: String,
    options _: SecureFileReadOptions?
  ) async throws -> Data {
    let context=FileSystemLogContext.forSecureOperation(
    ...
    do {
      ...
      guard
        ...
        let algorithm=SecureFileOptions.EncryptionAlgorithm(rawValue: algorithmString)
      else {
        throw FileSystemError.securityError(
          path: validatedPath,
      ...
      let successContext=context
        ...
        .withUpdatedMetadata(context.metadata.withPublic(
          key: "decryptedSize",
          value: String(decryptedData.count)
        ))
      ...
      // Re-throw already wrapped errors
      await logger.error(
        "Failed to securely read file: \(error.localizedDescription)",
        context: context
      )
      throw error
    } catch {
      ...
      await logger.error(
        "Failed to securely read file: \(wrappedError.localizedDescription)",
        context: context
      )
      throw wrappedError
    }
  ...
  public func secureDelete(at path: String, options: SecureDeletionOptions?) async throws {
    ...
    do {
      ...
      for pass in 1...passes {
        ...
        await logger.debug(
          "Performing secure deletion pass \(pass)/\(passes)",
        ...
        let bufferSize=min(
          FileManager.default.allocatedSizeOfFile(at: validatedPath),
          1024 * 1024
        ) // 1MB max
      ...
      // Re-throw already wrapped errors
      await logger.error(
        "Failed to securely delete file: \(error.localizedDescription)",
      ...
      await logger.error(
        "Failed to securely delete file: \(wrappedError.localizedDescription)",
        context: enhancedContext
      )
      throw wrappedError
    }
  ...
  public func setSecurePermissions(
    ...
    do {
      ...
      // Re-throw already wrapped errors
      await logger.error(
        "Failed to set secure permissions: \(error.localizedDescription)",
        context: enhancedContext
      )
      throw error
    } catch {
      ...
      await logger.error(
        "Failed to set secure permissions: \(wrappedError.localizedDescription)",
        context: enhancedContext
      )
      throw wrappedError
    }
  ...
  public func verifyFileIntegrity(at path: String, against signature: Data) async throws -> Bool {
    ...
    do {
      ...
      // Re-throw already wrapped errors
      await logger.error(
        "Failed to verify file integrity: \(error.localizedDescription)",
        context: context
      )
      throw error
    } catch {
      ...
      await logger.error(
        "Failed to verify file integrity: \(wrappedError.localizedDescription)",
        context: context
      )
      throw wrappedError
    }
