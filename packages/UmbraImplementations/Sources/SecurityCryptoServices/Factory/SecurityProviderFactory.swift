...
public enum SecurityProviderFactory {
     ...
     */
    public static func createProvider(type: SecurityProviderType? = nil) throws -> EncryptionProviderProtocol {
        ...
        case .apple:
            ...
            #else
            throw SecurityProtocolError.unsupportedOperation(name: "Apple CryptoKit is not available on this platform")
            #endif
        ...
        case .ring:
            ...
            #else
            throw SecurityProtocolError.unsupportedOperation(name: "Ring crypto is not available on this platform")
            #endif
