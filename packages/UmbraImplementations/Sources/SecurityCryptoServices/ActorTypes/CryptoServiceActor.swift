...
public actor CryptoServiceActor {
  ...
  public func encrypt(
    ...
    do {
      ...
      return .failure(SecurityProtocolError
 ...
 */
fileprivate struct DomainLogAdapter {
  private let logger: LoggingProtocol
 ...
 */
fileprivate class FallbackEncryptionProvider: EncryptionProviderProtocol {
  func encrypt(
    plaintext: Data,
    key: Data,
    iv: Data,
