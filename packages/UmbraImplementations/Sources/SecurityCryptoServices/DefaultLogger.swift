...
public class DefaultLogger: LoggingProtocol {
  ...
  /// Log trace message
  public func trace(_ message: String, metadata _: [String: String]?) async {
    logger.debug("TRACE: \(message)")
  }

  /// Log debug message
  public func debug(_ message: String, metadata _: [String: String]?) async {
    logger.debug("DEBUG: \(message)")
  }

  /// Log info message
  public func info(_ message: String, metadata _: [String: String]?) async {
    logger.info("INFO: \(message)")
  }

  /// Log notice message
  public func notice(_ message: String, metadata _: [String: String]?) async {
    logger.notice("NOTICE: \(message)")
  }

  /// Log warning message
  public func warning(_ message: String, metadata _: [String: String]?) async {
    logger.warning("WARNING: \(message)")
  }

  /// Log error message
  public func error(_ message: String, metadata _: [String: String]?) async {
    logger.error("ERROR: \(message)")
  }

  /// Log critical message
  public func critical(_ message: String, metadata _: [String: String]?) async {
