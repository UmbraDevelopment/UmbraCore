...
struct SnapshotResultParser {
    ...
    func parseSnapshotsList(output: String, repositoryID: String?) throws -> [BackupSnapshot] {
        ...
        do {
            ...
            throw BackupError.parsingError(details: "Failed to parse snapshots list: \(error.localizedDescription)")
        }
    }
    ...
    func parseSnapshotDetails(
        ...
        do {
            ...
            var fileStatistics: FileStatistics? = nil
            ...
            throw BackupError.parsingError(details: "Failed to parse snapshot details: \(error.localizedDescription)")
        }
    }
    ...
    func parseComparisonResult(
        ...
        do {
            ...
            throw BackupError.parsingError(details: "Failed to parse comparison result: \(error.localizedDescription)")
        }
    }
    ...
    /// - Throws: BackupError if parsing fails
    func parseFindResult(output: String, pattern: String) throws -> [SnapshotFile] {
        guard let data = output.data(using: .utf8) else {
            throw BackupError.parsingError(details: "Failed to convert output to data")
        }
        ...
        do {
            ...
            throw BackupError.parsingError(details: "Failed to parse find result: \(error.localizedDescription)")
        }
    }
    ...
    func parseNewSnapshotID(output: String) throws -> String {
        ...
        do {
            ...
            throw BackupError.parsingError(details: "Failed to parse copy result: \(error.localizedDescription)")
        }
    }
    ...
    func parseVerificationResult(
        ...
        do {
            ...
            throw BackupError.parsingError(details: "Failed to parse verification result: \(error.localizedDescription)")
        }
    }
    ...
    func parseResticJson<T: Decodable>(output: String) throws -> T {
        ...
        do {
            ...
            throw BackupError.parsingError(details: "Failed to parse Restic output: \(error.localizedDescription)")
        }
    }
}
