...
@preconcurrency public actor BackupServiceImpl: BackupServiceProtocol {
    ...
    public func createBackup(
        ...
        await logger.info("Creating backup", metadata: [
            "sources": sources.map { $0.path }.joined(separator: ", "),
            "excludePaths": excludePaths?.map { $0.path }.joined(separator: ", ") ?? "none",
    ...
    public func restoreBackup(
        ...
        await logger.info("Restoring backup", metadata: [
            ...
            "includePaths": includePaths?.map { $0.path }.joined(separator: ", ") ?? "all",
            "excludePaths": excludePaths?.map { $0.path }.joined(separator: ", ") ?? "none",
