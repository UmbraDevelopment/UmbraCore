...
public struct SnapshotListParameters: SnapshotOperationParameters {
    ...
    public func createLogContext() -> SnapshotLogContextAdapter {
        ...
        return context
            ...
            .with(path: path?.path, privacy: .sensitive)
 ...
 */
public struct SnapshotDeleteParameters: SnapshotOperationParameters {
    public let snapshotID: String
 ...
 */
public struct SnapshotCopyParameters: SnapshotOperationParameters {
    public let snapshotID: String
 ...
 */
public struct SnapshotLockParameters: SnapshotOperationParameters {
    public let snapshotID: String
 ...
 */
public struct SnapshotUnlockParameters: SnapshotOperationParameters {
    public let snapshotID: String
 ...
 */
public struct SnapshotRestoreParameters: SnapshotOperationParameters {
    public let snapshotID: String
 ...
 */
public struct SnapshotVerifyParameters: SnapshotOperationParameters {
    public let snapshotID: String
