...
extension BackupError {
  ...
  public static func unexpectedError(_ message: String) -> BackupError {
    BackupError.snapshotFailure(id: nil, reason: message)
  }
  ...
  public static func permissionError(_ detail: String) -> BackupError {
    .insufficientPermissions(path: detail)
  }
  ...
  public static func networkError(
    _ detail: String,
    context _: LoggingTypes.LogContextDTO?=nil
  ) -> BackupError {
    .repositoryAccessFailure(path: "network", reason: detail)
  }
  ...
  public static func invalidInputError(_ detail: String) -> BackupError {
    .invalidConfiguration(details: detail)
  }
  ...
  public static func snapshotError(id: String?, detail: String) -> BackupError {
    .snapshotFailure(id: id, reason: detail)
  }
}
