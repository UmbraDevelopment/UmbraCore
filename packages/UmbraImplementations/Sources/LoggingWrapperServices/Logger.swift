...
public final class Logger: LoggingWrapperInterfaces.LoggerProtocol, @unchecked Sendable {
  ...
  @MainActor private static var configuration: LoggingWrapperInterfaces.LoggerConfiguration = .production
  ...
  public static func isEnabled(_ level: LoggingWrapperInterfaces.LogLevel) -> Bool {
    ...
    return level.rawValue >= LoggingWrapperInterfaces.LogLevel.trace.rawValue
  }
  ...
  private actor SwiftyLoggerActor {
    ...
    private func processMessage(_ message: String, privacy: LoggingWrapperInterfaces.LogPrivacyLevel) -> String {
  ...
  private static func convertLogLevel(_ level: LoggingWrapperInterfaces.LogLevel) -> SwiftyBeaver.Level {
    switch level {
    case .debug:
      return .debug
    case .info:
  ...
  public final class PrivacyAwareLoggerImplementation: LoggingInterfaces.PrivacyAwareLoggingProtocol {
    ...
    public init(actor: LoggingInterfaces.LoggingActor) {
      self.loggingActor = actor
    }
    
    // MARK: - CoreLoggingProtocol
    
    /// Log a message with the specified level and context
    public func logMessage(_ level: LoggingTypes.LogLevel, _ message: String, context: LoggingTypes.LogContext) async {
    ...
    public func logSensitive(
      ...
      await self.logMessage(level, finalMessage, context: context)
    }
    ...
    public func logError(
      ...
      await self.logMessage(.error, finalMessage, context: context) 
    }
