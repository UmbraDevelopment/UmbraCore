 ...
 */
public actor SecureLoggerActor: Sendable {
    // MARK: - Properties
    ...
    public func securityEvent(
        ...
        for (key, taggedValue) in additionalMetadata {
            metadata = metadata.with(
                ...
                privacyLevel: taggedValue.privacyLevel
            )
        }
    ...
    public func authenticationEvent(
        ...
        combinedMetadata["method"] = PrivacyTaggedValue(value: .string(method), privacyLevel: .public)
    ...
    public func authorisationEvent(
        ...
        var combinedMetadata = additionalMetadata
        combinedMetadata["permission"] = PrivacyTaggedValue(value: .string(permission), privacyLevel: .public)
    ...
    public func dataAccessEvent(
        ...
        var combinedMetadata = additionalMetadata
        combinedMetadata["operation"] = PrivacyTaggedValue(value: .string(operation), privacyLevel: .public)
    ...
    public func cryptoOperationEvent(
        ...
        var combinedMetadata = additionalMetadata
        combinedMetadata["algorithm"] = PrivacyTaggedValue(value: .string(algorithm), privacyLevel: .public)
...
public struct PrivacyTaggedValue: Sendable, Equatable {
     ...
     */
    public init(value: PrivacyMetadataValue, privacyLevel: PrivacyLevel) {
        self.value = value
