...
public actor SecurityServiceActor: SecurityProviderProtocol, AsyncServiceInitializable {
  ...
  private var configuration: SecurityInterfaces.SecurityConfigurationDTO
  ...
  public func initialize() async throws {
    ...
    let contextWithConfig=logContext
      .adding(
        key: "securityLevel",
        value: configuration.securityLevel.rawValue,
        privacyLevel: .public
      )
      .adding(
        key: "loggingLevel",
        value: configuration.loggingLevel.rawValue,
        privacyLevel: .public
      )
  ...
  public func createSecureConfig(options _: SecurityConfigOptions) async -> SecurityConfigDTO {
    SecurityConfigDTO(
